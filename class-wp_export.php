...
class Wp_Export {
	...
	public function __construct( $args = array()) {
		...
		self::display_xml_header( $post_ids );

		self::display_terms( $args, $cats, $tags, $terms);

		/** This action is documented in wp-includes/feed-rss2.php */
		do_action( 'rss2_head' );

		self::display_items( $post_ids );

		self::display_xml_footer();
	}


	static function display_xml_header( $post_ids ) {
	...
	static function display_xml_footer(){ ?>
			</channel>
		</rss>
	<?php }

	static function display_terms( $args=array(), $cats=array(), $tags=array(), $terms=array() ){
	...
	static function display_items( $post_ids) {
	...
	static function display_item( $post ){
		global $wpdb;
		setup_postdata( $post );
