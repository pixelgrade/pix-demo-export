 ...
 */
class DemoXmlProcessorImpl implements DemoXmlProcessor {

	/** @var DemoXmlMeta plugin configuration */
	protected $meta = null;

	/** @var DemoXmlMeta field information */
	...
	/** @var DemoXmlMeta current data; including submitted data */
	protected $data = null;
