 ...
 */
class DemoXmlFormImpl extends DemoXmlHTMLElementImpl implements DemoXmlForm {
	...
	/** @var DemoXmlMeta autocomplete */
	protected $autocomplete = null;

	/**
	 * Autocomplete meta object passed on by the processor.
	 *
	 * @param DemoXmlMeta autocomplete values
	 * @return static $this
	 */
	function autocomplete(DemoXmlMeta $autocomplete) {
	...
	/**
	 * @param string template path
	 * @param DemoXmlMeta configuration
	 * @return string
	 */
	protected function fieldtemplate_render($_template_path, DemoXmlMeta $conf) {
